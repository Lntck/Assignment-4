...
public interface Carnivore {
    default Animal choosePrey(List<Animal> animals, Animal hunter) throws SelfHuntingException, CannibalismException, TooStrongPreyException {
    ...
    default void huntPrey(Animal hunter, Animal prey) throws SelfHuntingException, CannibalismException, TooStrongPreyException {
